...
start /min "Livetrader" "C:\MQL_Projekt\Livetrader\terminal64.exe" /portable /config:"C:\MQL_Projekt\Livetrader\Config\KUBE_autostart_live.ini"
timeout /t 6 /nobreak

echo Starte Papertrader_10...
start /min "Papertrader_10" "C:\MQL_Projekt\Papertrader_10\terminal64.exe" /portable /config:"C:\MQL_Projekt\Papertrader_10\Config\KUBE_autostart_paper10.ini"
timeout /t 1 /nobreak
::=================================================================================================
